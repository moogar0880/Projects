...
floor plan of width and height, using a cost entered by
the user.

Input can be integers or floats
'''
...
print "The total cost is $%.2f for %.2f square feet" % (width * height * cost, width * height)
